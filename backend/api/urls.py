...
from .views import get_user_data,RegisterView, LoginView, UserDetailView, csrf_token_view, logout_view, save_consultation, generate_pdf, predict_disease_api # Import all views used
